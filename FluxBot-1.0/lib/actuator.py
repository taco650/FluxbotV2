...
class Actuator:
    ...
    def __init__(self, acuationTime = CONSTANTS.ACTUATION_TIME):
        ...
        Actuator.pwm_pin = Actuator.pwm.channel(0, pin = CONSTANTS.ACTUATOR_PIN, duty_cycle = 0.00)
    ...
    def update():
        ...
        Actuator.pwm_pin = Actuator.pwm.channel(0, pin = CONSTANTS.ACTUATOR_PIN, duty_cycle = dutyCycle)
